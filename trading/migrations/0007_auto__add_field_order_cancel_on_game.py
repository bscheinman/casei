...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Order.cancel_on_game'
        db.add_column('trading_order', 'cancel_on_game', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Order.cancel_on_game'
        db.delete_column('trading_order', 'cancel_on_game')
