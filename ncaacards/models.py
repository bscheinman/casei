...
class NcaaGame(models.Model):
    ...
    game_type = models.ForeignKey(GameType, related_name='games') #This is only null for migration purposes
...
class ScoreType(models.Model):
    ...
    game_type = models.ForeignKey(GameType, related_name='score_types') #This is only null for migration purposes
...
class Team(models.Model):
    ...
    game_type = models.ForeignKey(GameType, related_name='teams') #This is only null for migration purposes
