...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field game_teams_desired on 'TradingBlock'
        db.create_table('ncaacards_tradingblock_game_teams_desired', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('tradingblock', models.ForeignKey(orm['ncaacards.tradingblock'], null=False)),
            ('gameteam', models.ForeignKey(orm['ncaacards.gameteam'], null=False))
        ))
        db.create_unique('ncaacards_tradingblock_game_teams_desired', ['tradingblock_id', 'gameteam_id'])

        # Adding M2M table for field game_teams_available on 'TradingBlock'
        db.create_table('ncaacards_tradingblock_game_teams_available', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('tradingblock', models.ForeignKey(orm['ncaacards.tradingblock'], null=False)),
            ('gameteam', models.ForeignKey(orm['ncaacards.gameteam'], null=False))
        ))
        db.create_unique('ncaacards_tradingblock_game_teams_available', ['tradingblock_id', 'gameteam_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field game_teams_desired on 'TradingBlock'
        db.delete_table('ncaacards_tradingblock_game_teams_desired')

        # Removing M2M table for field game_teams_available on 'TradingBlock'
        db.delete_table('ncaacards_tradingblock_game_teams_available')
