...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'NcaaGame.points_limit'
        db.add_column('ncaacards_ncaagame', 'points_limit', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'NcaaGame.points_limit'
        db.delete_column('ncaacards_ncaagame', 'points_limit')
