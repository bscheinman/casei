...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TradeOffer.offer_time'
        db.add_column('ncaacards_tradeoffer', 'offer_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2012, 2, 21, 18, 55, 35, 957323), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TradeOffer.offer_time'
        db.delete_column('ncaacards_tradeoffer', 'offer_time')
