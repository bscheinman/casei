...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'NcaaGame.settings_locked'
        db.add_column('ncaacards_ncaagame', 'settings_locked', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'NcaaGame.settings_locked'
        db.delete_column('ncaacards_ncaagame', 'settings_locked')
