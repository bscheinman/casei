...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TradeOffer.accepting_user'
        db.add_column('ncaacards_tradeoffer', 'accepting_user', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='accepted_trades', null=True, to=orm['ncaacards.UserEntry']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TradeOffer.accepting_user'
        db.delete_column('ncaacards_tradeoffer', 'accepting_user_id')
