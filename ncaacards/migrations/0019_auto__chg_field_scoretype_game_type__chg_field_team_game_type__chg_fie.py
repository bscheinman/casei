...
class Migration(SchemaMigration):
    ...
    # At this point it is guaranteed that all game types will be non-null because of the previous data migration    
    def forwards(self, orm):
        
        # Changing field 'ScoreType.game_type'
        db.alter_column('ncaacards_scoretype', 'game_type_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['ncaacards.GameType']))

        # Changing field 'Team.game_type'
        db.alter_column('ncaacards_team', 'game_type_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['ncaacards.GameType']))

        # Changing field 'NcaaGame.game_type'
        db.alter_column('ncaacards_ncaagame', 'game_type_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['ncaacards.GameType']))


    def backwards(self, orm):
        
        # Changing field 'ScoreType.game_type'
        db.alter_column('ncaacards_scoretype', 'game_type_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['ncaacards.GameType']))

        # Changing field 'Team.game_type'
        db.alter_column('ncaacards_team', 'game_type_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['ncaacards.GameType']))

        # Changing field 'NcaaGame.game_type'
        db.alter_column('ncaacards_ncaagame', 'game_type_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['ncaacards.GameType']))
