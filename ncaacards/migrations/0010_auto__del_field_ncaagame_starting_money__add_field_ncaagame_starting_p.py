...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'NcaaGame.starting_money'
        db.delete_column('ncaacards_ncaagame', 'starting_money')

        # Adding field 'NcaaGame.starting_points'
        db.add_column('ncaacards_ncaagame', 'starting_points', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'UserEntry.extra_points'
        db.add_column('ncaacards_userentry', 'extra_points', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Deleting field 'TradeSide.dollar_amount'
        db.delete_column('ncaacards_tradeside', 'dollar_amount')

        # Adding field 'TradeSide.points'
        db.add_column('ncaacards_tradeside', 'points', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'NcaaGame.starting_money'
        db.add_column('ncaacards_ncaagame', 'starting_money', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Deleting field 'NcaaGame.starting_points'
        db.delete_column('ncaacards_ncaagame', 'starting_points')

        # Deleting field 'UserEntry.extra_points'
        db.delete_column('ncaacards_userentry', 'extra_points')

        # Adding field 'TradeSide.dollar_amount'
        db.add_column('ncaacards_tradeside', 'dollar_amount', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Deleting field 'TradeSide.points'
        db.delete_column('ncaacards_tradeside', 'points')
