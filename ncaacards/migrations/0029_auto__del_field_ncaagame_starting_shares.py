...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'NcaaGame.starting_shares'
        db.delete_column('ncaacards_ncaagame', 'starting_shares')


    def backwards(self, orm):
        
        # Adding field 'NcaaGame.starting_shares'
        db.add_column('ncaacards_ncaagame', 'starting_shares', self.gf('django.db.models.fields.IntegerField')(default=100), keep_default=False)
