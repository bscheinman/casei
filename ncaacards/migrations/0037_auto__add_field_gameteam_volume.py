...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'GameTeam.volume'
        db.add_column('ncaacards_gameteam', 'volume', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'GameTeam.volume'
        db.delete_column('ncaacards_gameteam', 'volume')
