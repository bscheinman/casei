...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ScoreType.ordering'
        db.add_column('ncaacards_scoretype', 'ordering', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ScoreType.ordering'
        db.delete_column('ncaacards_scoretype', 'ordering')
