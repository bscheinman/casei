...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Team', fields ['game_type', 'abbrev_name']
        db.create_unique('ncaacards_team', ['game_type_id', 'abbrev_name'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Team', fields ['game_type', 'abbrev_name']
        db.delete_unique('ncaacards_team', ['game_type_id', 'abbrev_name'])
    ...
    models = {
        ...
        'ncaacards.team': {
            'Meta': {'unique_together': "(('abbrev_name', 'game_type'),)", 'object_name': 'Team'},
