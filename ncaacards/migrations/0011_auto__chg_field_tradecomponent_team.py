...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TradeComponent.team'
        db.alter_column('ncaacards_tradecomponent', 'team_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ncaacards.GameTeam']))


    def backwards(self, orm):
        
        # Changing field 'TradeComponent.team'
        db.alter_column('ncaacards_tradecomponent', 'team_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ncaacards.Team']))
