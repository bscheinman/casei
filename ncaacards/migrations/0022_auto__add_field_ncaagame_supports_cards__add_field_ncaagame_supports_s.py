...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'NcaaGame.supports_cards'
        db.add_column('ncaacards_ncaagame', 'supports_cards', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'NcaaGame.supports_stocks'
        db.add_column('ncaacards_ncaagame', 'supports_stocks', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'NcaaGame.supports_cards'
        db.delete_column('ncaacards_ncaagame', 'supports_cards')

        # Deleting field 'NcaaGame.supports_stocks'
        db.delete_column('ncaacards_ncaagame', 'supports_stocks')
