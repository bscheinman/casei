...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'ScoreType', fields ['ordering']
        db.delete_unique('ncaacards_scoretype', ['ordering'])

        # Adding unique constraint on 'ScoreType', fields ['ordering', 'game_type']
        db.create_unique('ncaacards_scoretype', ['ordering', 'game_type_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'ScoreType', fields ['ordering', 'game_type']
        db.delete_unique('ncaacards_scoretype', ['ordering', 'game_type_id'])

        # Adding unique constraint on 'ScoreType', fields ['ordering']
        db.create_unique('ncaacards_scoretype', ['ordering'])
