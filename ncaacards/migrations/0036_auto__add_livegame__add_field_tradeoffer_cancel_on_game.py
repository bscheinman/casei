...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'LiveGame'
        db.create_table('ncaacards_livegame', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('home_team', self.gf('django.db.models.fields.related.ForeignKey')(related_name='home_games', to=orm['ncaacards.Team'])),
            ('away_team', self.gf('django.db.models.fields.related.ForeignKey')(related_name='away_games', to=orm['ncaacards.Team'])),
            ('game_time', self.gf('django.db.models.fields.DateTimeField')()),
            ('is_processed', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('ncaacards', ['LiveGame'])

        # Adding field 'TradeOffer.cancel_on_game'
        db.add_column('ncaacards_tradeoffer', 'cancel_on_game', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'LiveGame'
        db.delete_table('ncaacards_livegame')

        # Deleting field 'TradeOffer.cancel_on_game'
        db.delete_column('ncaacards_tradeoffer', 'cancel_on_game')
