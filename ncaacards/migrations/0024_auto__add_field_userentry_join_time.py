...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserEntry.join_time'
        db.add_column('ncaacards_userentry', 'join_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2012, 3, 4, 15, 28, 25, 468692), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserEntry.join_time'
        db.delete_column('ncaacards_userentry', 'join_time')
