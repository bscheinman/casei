...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'NcaaGame.position_limit'
        db.add_column('ncaacards_ncaagame', 'position_limit', self.gf('django.db.models.fields.IntegerField')(default=100), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'NcaaGame.position_limit'
        db.delete_column('ncaacards_ncaagame', 'position_limit')
