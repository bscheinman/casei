...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Team', fields ['full_name']
        db.create_unique('ncaacards_team', ['full_name'])

        # Adding unique constraint on 'Team', fields ['abbrev_name']
        db.create_unique('ncaacards_team', ['abbrev_name'])

        # Adding unique constraint on 'NcaaGame', fields ['name']
        db.create_unique('ncaacards_ncaagame', ['name'])

        # Adding unique constraint on 'UserEntry', fields ['game', 'entry_name']
        db.create_unique('ncaacards_userentry', ['game_id', 'entry_name'])

        # Changing field 'UserTeam.team'
        db.alter_column('ncaacards_userteam', 'team_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ncaacards.GameTeam']))


    def backwards(self, orm):
        
        # Removing unique constraint on 'UserEntry', fields ['game', 'entry_name']
        db.delete_unique('ncaacards_userentry', ['game_id', 'entry_name'])

        # Removing unique constraint on 'NcaaGame', fields ['name']
        db.delete_unique('ncaacards_ncaagame', ['name'])

        # Removing unique constraint on 'Team', fields ['abbrev_name']
        db.delete_unique('ncaacards_team', ['abbrev_name'])

        # Removing unique constraint on 'Team', fields ['full_name']
        db.delete_unique('ncaacards_team', ['full_name'])

        # Changing field 'UserTeam.team'
        db.alter_column('ncaacards_userteam', 'team_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ncaacards.Team']))
