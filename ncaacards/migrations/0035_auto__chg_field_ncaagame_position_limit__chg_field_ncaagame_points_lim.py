...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'NcaaGame.position_limit'
        db.alter_column('ncaacards_ncaagame', 'position_limit', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'NcaaGame.points_limit'
        db.alter_column('ncaacards_ncaagame', 'points_limit', self.gf('django.db.models.fields.IntegerField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'NcaaGame.position_limit'
        db.alter_column('ncaacards_ncaagame', 'position_limit', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'NcaaGame.points_limit'
        db.alter_column('ncaacards_ncaagame', 'points_limit', self.gf('django.db.models.fields.IntegerField')())
