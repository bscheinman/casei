...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ScoreType.game_type'
        db.add_column('ncaacards_scoretype', 'game_type', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='score_types', null=True, to=orm['ncaacards.GameType']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ScoreType.game_type'
        db.delete_column('ncaacards_scoretype', 'game_type_id')
    ...
    models = {
        ...
        'ncaacards.scoretype': {
            ...
            'game_type': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'score_types'", 'null': 'True', 'to': "orm['ncaacards.GameType']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
