...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TradeOffer.accept_time'
        db.add_column('ncaacards_tradeoffer', 'accept_time', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TradeOffer.accept_time'
        db.delete_column('ncaacards_tradeoffer', 'accept_time')
