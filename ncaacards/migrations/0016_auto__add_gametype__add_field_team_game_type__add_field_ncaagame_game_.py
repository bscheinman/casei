...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('ncaacards_gametype', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=20)),
        ))
        db.send_create_signal('ncaacards', ['GameType'])

        # Adding field 'Team.game_type'
        db.add_column('ncaacards_team', 'game_type', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='teams', null=True, to=orm['ncaacards.GameType']), keep_default=False)

        # Adding field 'NcaaGame.game_type'
        db.add_column('ncaacards_ncaagame', 'game_type', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='games', null=True, to=orm['ncaacards.GameType']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'GameType'
        db.delete_table('ncaacards_gametype')

        # Deleting field 'Team.game_type'
        db.delete_column('ncaacards_team', 'game_type_id')

        # Deleting field 'NcaaGame.game_type'
        db.delete_column('ncaacards_ncaagame', 'game_type_id')
    ...
    models = {
        ...
        'ncaacards.ncaagame': {
            ...
            'game_type': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'games'", 'null': 'True', 'to': "orm['ncaacards.GameType']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'ncaacards.team': {
            ...
            'game_type': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'teams'", 'null': 'True', 'to': "orm['ncaacards.GameType']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
