...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Team.is_eliminated'
        db.add_column('ncaacards_team', 'is_eliminated', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Team.is_eliminated'
        db.delete_column('ncaacards_team', 'is_eliminated')
