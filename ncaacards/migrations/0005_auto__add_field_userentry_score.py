...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserEntry.score'
        db.add_column('ncaacards_userentry', 'score', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserEntry.score'
        db.delete_column('ncaacards_userentry', 'score')
