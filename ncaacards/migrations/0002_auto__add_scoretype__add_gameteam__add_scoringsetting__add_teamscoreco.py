...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('ncaacards_scoretype', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('default_score', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('ncaacards', ['ScoreType'])

        # Adding model 'GameTeam'
        db.create_table('ncaacards_gameteam', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('ncaacards', ['GameTeam'])

        # Adding model 'ScoringSetting'
        db.create_table('ncaacards_scoringsetting', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('game', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ncaacards.NcaaGame'])),
            ('scoreType', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ncaacards.ScoreType'])),
            ('points', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('ncaacards', ['ScoringSetting'])

        # Adding model 'TeamScoreCount'
        db.create_table('ncaacards_teamscorecount', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('team', self.gf('django.db.models.fields.related.ForeignKey')(related_name='counts', to=orm['ncaacards.Team'])),
            ('scoreType', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ncaacards.ScoreType'])),
            ('count', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal('ncaacards', ['TeamScoreCount'])

        # Deleting field 'Team.score'
        db.delete_column('ncaacards_team', 'score')


    def backwards(self, orm):
        
        # Deleting model 'ScoreType'
        db.delete_table('ncaacards_scoretype')

        # Deleting model 'GameTeam'
        db.delete_table('ncaacards_gameteam')

        # Deleting model 'ScoringSetting'
        db.delete_table('ncaacards_scoringsetting')

        # Deleting model 'TeamScoreCount'
        db.delete_table('ncaacards_teamscorecount')

        # Adding field 'Team.score'
        db.add_column('ncaacards_team', 'score', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)
