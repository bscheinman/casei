...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TradeOffer.is_active'
        db.add_column('ncaacards_tradeoffer', 'is_active', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TradeOffer.is_active'
        db.delete_column('ncaacards_tradeoffer', 'is_active')
