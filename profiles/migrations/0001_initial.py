...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('profiles_userprofile', (
            ...
            ('verification_id', self.gf('casei.fields.UUIDField')(unique=True, max_length=32, blank=True)),
    ...
    models = {
        ...
        'profiles.userprofile': {
            ...
            'verification_id': ('casei.fields.UUIDField', [], {'unique': 'True', 'max_length': '32', 'blank': 'True'})
        }
    }
